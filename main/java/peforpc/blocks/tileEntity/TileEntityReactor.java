...
public class TileEntityReactor extends TileEntity {
	...
	public static ItemStack[] lootTable = new ItemStack[] {
			...
			new ItemStack(Blocks.red_mushroom), new ItemStack(Items.bone),
	...
	public void readFromNBT(NBTTagCompound tagCom) {
		...
		NBTTagList degrateList = tagCom.getTagList("degrateList",9);
	...
	private void spawnEntities() {
		...
		List<Entity> zombiesAround = this.worldObj.getEntitiesWithinAABB(
				EntityPigZombie.class, AxisAlignedBB.getBoundingBox(
						...
						this.xCoord + 6, this.yCoord + 2, this.zCoord + 6));
		int maxZombies = 0;
		switch (this.worldObj.difficultySetting.getDifficultyId()) {
		case 1:
			maxZombies = 10;
			break;
		case 2:
