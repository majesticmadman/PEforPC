...
{
    private TileEntityStoneCutter tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerCutter(TileEntityStoneCutter forge)
    {
        this.tileFurnace = forge;
        this.addSlotToContainer(new Slot(forge, 0, 60, 17));
        this.addSlotToContainer(new Slot(forge, 1, 53, 53));
        int i;
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (p_82846_2_ != 1 && p_82846_2_ != 0)
            {
                ...
                else if (TileEntityStoneCutter.isItemFuel(itemstack1))
                {
